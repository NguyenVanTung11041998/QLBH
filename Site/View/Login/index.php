			...
			<div class="col-md-8 account-top">
				<form id="formLogin" method="post">
					...
					<div> 	
						...
						<input type="text" name="txtTenDangNhap" id="txtTenDangNhap" placeholder="Tên đăng nhập" /> 
					</div>
					<div> 
						<span >Mật khẩu</span>
						<input type="password" name="txtPassword" id="txtPassword" placeholder="Mật khảu" />
					</div>				
