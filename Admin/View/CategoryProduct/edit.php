    ...
    <div class="col-lg-12">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Mã loại sản phẩm</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="" name="txtMaLoaiSP" value="<?php echo $loaiSanPham->GetMaLoaiSP();?>" readonly="true"> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="" placeholder="Tên loại" name="txtTenLoaiSP" value="<?php echo $loaiSanPham->GetTenLoai();?>">
                ...
                <div class="col-sm-8">
                    <select class="form-control col-md-8" name="cmbMaDanhMuc">
                        <?php 
                            ...
                            {
                            ?>
                                <option value="<?php echo $value->GetMaDanhMuc();?>" <?php if($loaiSanPham->GetMaDanhMuc() == $value->GetMaDanhMuc()) echo 'selected="selected"';?>><?php echo $value->GetTenDanhMuc(); ?></option>
                            <?php
                            }
                        ?>
                    </select>
